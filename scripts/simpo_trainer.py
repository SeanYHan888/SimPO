...
class SimPOTrainer(Trainer):
    ...
    def generate_policy_samples(self, model, batch: Dict[str, torch.LongTensor]) -> List[str]:
    ...
    def evaluation_loop(
        ...
        if self.generate_during_eval:
            ...
            policy_output_decoded = self.generate_policy_samples(self.model, random_batch)
